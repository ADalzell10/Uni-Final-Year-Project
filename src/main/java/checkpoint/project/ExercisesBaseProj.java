...
import checkpoint.project.IaaSForwarderProj;
import checkpoint.project.PMForwarderProj;
...
public class ExercisesBaseProj {
	...
	private static ArrayList<PMForwarderProj> pmfs = new ArrayList<PMForwarderProj>();
	public static List<PMForwarderProj> pmforwarders = Collections.unmodifiableList(pmfs);

	private static ArrayList<IaaSForwarderProj> ifs = new ArrayList<IaaSForwarderProj>();
	public static List<IaaSForwarderProj> iaasforwarders = Collections.unmodifiableList(ifs);
	...
	public static PhysicalMachine getNewPhysicalMachine(final double reliMult)
		...
		PMForwarderProj f = new PMForwarderProj((double) RandomUtils.nextInt(1, maxCoreCount),
	...
	public static void dropPM(PhysicalMachine pm) {
		if (pm instanceof PMForwarderProj) {
			pmfs.remove((PMForwarderProj) pm);
	...
	public static IaaSService getNewIaaSService() throws IllegalArgumentException, SecurityException,
		...
		IaaSForwarderProj f = new IaaSForwarderProj(vmSchClasses[RandomUtils.nextInt(0, vmSchClasses.length)],
	...
	public static IaaSService getComplexInfrastructure(final int pmCount)
		...
		IaaSService iaas = ExercisesBaseProj.getNewIaaSService();
		Repository centralStorage = ExercisesBaseProj.getNewRepository(pmCount);
		...
		for (int i = 0; i < pmCount; i++) {
			PhysicalMachine curr = ExercisesBaseProj.getNewPhysicalMachine();
			pmlist.add(curr);
